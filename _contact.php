...
get_header(); ?>
    ...
    <div class="content">
       ...
       <div class="donate-text left shortcodes">
 ...
 <div class="clear"></div>
            <div class="form-left">
               <form method="POST" id="contactform" onsubmit="return checkForm(this)" action="<?php echo get_template_directory_uri().'/sendcontact.php'?>">
                       ...
                       <div class="form-div left"><span><?php _e('Name and Surname:', tk_theme_name); ?></span>
                    ...
                    <div class="form-button">
                      <div class="red">
                        ...
                        <div class="red-center"><input name="submit" type="submit" id="submit" class="emailsubmit"  tabindex="5" value="<?php _e('Send Now', tk_theme_name); ?>" onclick="return checkForm(this)" /></div>
