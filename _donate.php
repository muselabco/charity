...
<?php  $currency  = get_option(THEME_NAME.'_currency');  ?>
                                    ...
                                    <div class="form-button">
                                        <a href="javascript:document.forms['paypalform'].submit();">
                                            <div class="red">
                                                ...
                                                <div class="red-center"><?php _e('Donate Now', tk_theme_name); ?></div>
                ...
                <div class="donate-text-down left"><?php _e('After pressing Donate now button you will be redirected to the PayPal payment page', tk_theme_name); ?></div>
