...
Template Name: Our Actions with Sidebar
...
?>
 ...
 <div class="content">
      ...
      <div class="other-content-side no-margin shortcodes">
    ...
    <div class="our-actions-sidebar left">
            ...
            <div class="our-actions-one left <?php echo $nomargin;?>">
                    <div class="our-actions-img left">
                        <div class="mosaic-block cover3">
                                <div class="mosaic-overlay"><?php the_post_thumbnail( 'our-actions-page' );?></div>
