  ...
  <div class="comment-start">
                            <div class="comment-start-one left">
                                ...
                                <div class="comment-start-title left">
                                 <span>   <?php printf(__('%s', tk_theme_name), comment_author()) ?></span>
                                   <p> <?php_e('On:', tk_theme_name); ?><?php printf(__('%1$s', tk_theme_name), get_comment_date()) ?>
		...
		<span class="commentmetadata-waiting" style="float:left;"><?php _e('Your comment is awaiting moderation.', tk_theme_name) ?></span>
		<?php endif; ?> 
