...
<script type="text/javascript">
	jQuery(document).ready(function() {
                    ...
                    //Panel changer
                    jQuery('.admin-nav').click(function(){
                        var rev = jQuery(this).attr('rev');
                        jQuery('.mainspan').addClass('hide');
                        jQuery('.'+rev).removeClass('hide');
                    ...
                    jQuery('.admin-nav').first().addClass('active-nav');
                    jQuery('.mainspan').first().removeClass('hide');
