            ...
            <div class="content-wrap-left left">
                ...
                <div class="blog-content left">
                    <div class="blog-title-date left">
                        <div class="blog-title left"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></div>
                        <span><?php the_time('F j, Y'); ?> | <a href="<?php echo get_permalink(); ?>">Comments: <?php comments_number( '0', '1', '%' ); ?></a></span>
                    </div><!--/comment-start-title-->
                    <div class="blog-images left"><a  href="<?php echo get_permalink(); ?>"><?php the_post_thumbnail( 'blog-page' ); ?></a></div>
                ...
                <div class="blog-content left">
                    <div class="blog-title-date left">
                        <div class="blog-title left"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></div>
                        <span><?php echo  the_time('F j, Y'); ?> | <a href="<?php echo get_permalink(); ?>">Comments: <?php comments_number( '0', '1', '%' ); ?></a></span>
                    </div><!--/comment-start-title-->
